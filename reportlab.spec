...
Source0  : https://files.pythonhosted.org/packages/11/36/8b01d3b6c2d44bbfc013ab6b61e876d576a38edc96b4bd508dcefe1b6e80/reportlab-3.5.47.tar.gz
...
%prep
%setup -q -n reportlab-3.5.47
cd %{_builddir}/reportlab-3.5.47
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597081864
...
cp %{_builddir}/reportlab-3.5.47/LICENSE.txt %{buildroot}/usr/share/package-licenses/reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.5.47/src/reportlab/fonts/bitstream-vera-license.txt %{buildroot}/usr/share/package-licenses/reportlab/b3245f6ac784e19a10843831b45b5944c62e3ccc
cp %{_builddir}/reportlab-3.5.47/src/reportlab/license.txt %{buildroot}/usr/share/package-licenses/reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.5.47/src/rl_addons/renderPM/libart_lgpl/COPYING %{buildroot}/usr/share/package-licenses/reportlab/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
