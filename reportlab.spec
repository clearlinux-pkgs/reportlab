...
Version  : 3.5.44
Release  : 41
URL      : https://files.pythonhosted.org/packages/98/07/5709d37f517269679d42128650e5f5ab186ad0896472c13e8b430c128eb1/reportlab-3.5.44.tar.gz
...
%prep
%setup -q -n reportlab-3.5.44
cd %{_builddir}/reportlab-3.5.44
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593468756
...
cp %{_builddir}/reportlab-3.5.44/LICENSE.txt %{buildroot}/usr/share/package-licenses/reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.5.44/src/reportlab/fonts/bitstream-vera-license.txt %{buildroot}/usr/share/package-licenses/reportlab/b3245f6ac784e19a10843831b45b5944c62e3ccc
cp %{_builddir}/reportlab-3.5.44/src/reportlab/license.txt %{buildroot}/usr/share/package-licenses/reportlab/638e7067709f6721a407b256bd4ed84cb1737106
cp %{_builddir}/reportlab-3.5.44/src/rl_addons/renderPM/libart_lgpl/COPYING %{buildroot}/usr/share/package-licenses/reportlab/bf50bac24e7ec325dbb09c6b6c4dcc88a7d79e8f
